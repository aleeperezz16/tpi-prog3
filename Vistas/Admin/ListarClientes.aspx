        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style4">&nbsp;</td>
                    <td>
                        <asp:GridView ID="gdvClientes" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnPageIndexChanging="gdvClientes_PageIndexChanging" OnRowCancelingEdit="gdvClientes_RowCancelingEdit" OnRowDataBound="gdvClientes_RowDataBound" OnRowDeleting="gdvClientes_RowDeleting" OnRowEditing="gdvClientes_RowEditing" OnRowUpdating="gdvClientes_RowUpdating">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Codigo de Ciudad">
                                    <EditItemTemplate>
