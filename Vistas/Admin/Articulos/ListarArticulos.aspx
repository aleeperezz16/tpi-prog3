            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style3">
                        <asp:HyperLink ID="hlkInicio" runat="server" NavigateUrl="~/Inicio.aspx">Volver al menú Principal</asp:HyperLink>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style3">&nbsp;</td>
                    <td>
                        Buscar artículos por id:<asp:TextBox ID="txtIdArticulo" runat="server" TextMode="Number"></asp:TextBox>
